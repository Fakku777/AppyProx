...
implements IScreenBase {
    ...
    protected boolean renderTooltips(class_332 guiGraphics, int par1, int par2, float par3) {
        boolean result = this.modMain.getWidgetScreenHandler().renderTooltips(guiGraphics, this, this.field_22789, this.field_22790, par1, par2, this.field_22787.method_22683().method_4495());
        ...
        for (class_364 el : this.method_25396()) {
            ...
            if (par1 < b.method_46426() || par2 < b.method_46427() || par1 >= b.method_46426() + b.method_25368() || par2 >= b.method_46427() + b.method_25364() || optionWidget.getXaero_tooltip() == null || (tooltip = optionWidget.getXaero_tooltip().get()) == null) continue;
