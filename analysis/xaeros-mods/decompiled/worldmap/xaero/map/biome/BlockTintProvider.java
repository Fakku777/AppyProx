...
implements class_1920 {
    ...
    public int method_23752(class_2338 blockPos, class_6539 colorResolver) {
        this.mutablePos.method_10101((class_2382)blockPos);
    ...
    public int getBiomeColor(class_2338 blockPos, class_2680 state, boolean overlay, MapTile tile, int caveLayer) {
        ...
        try {
            return class_310.method_1551().method_1505().method_1697(state, (class_1920)this, blockPos, this.mapWriter.getBlockTintIndex(state));
        }
        catch (Throwable t) {
            this.brokenBlockTintCache.setBroken(state);
            WorldMap.LOGGER.error("Error calculating block tint for block state " + String.valueOf(state) + "! Total: " + this.brokenBlockTintCache.getSize(), t);
            return -1;
        }
    }
}
