...
public class MultiTextureRenderTypeRenderer {
    private static final String RENDER_PASS_NAME = "xaero wm multitexture render pass";
    ...
    void draw() {
        ...
        if (!this.texturesForDrawCalls.isEmpty()) {
            ...
            RenderPipeline renderPipeline = ((ICompositeRenderType)this.renderType).xaero_wm_getRenderPipeline();
            ICompositeState compositeState = ((ICompositeRenderType)this.renderType).xaero_wm_getState();
            class_276 target = CustomRenderTypes.getOutputStateTarget(compositeState.xaero_wm_getOutputState());
