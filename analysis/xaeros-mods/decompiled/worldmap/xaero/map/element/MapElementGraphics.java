...
public class MapElementGraphics {
    ...
    public final void blit(class_1058 sprite, int x, int y, int width, int height, RenderPipeline renderPipeline) {
        ...
        ImmediateRenderUtil.texturedRect(this.pose(), x, y, sprite.method_4594(), sprite.method_4593(), width, height, sprite.method_4577(), sprite.method_4575(), 1.0f, renderPipeline);
    }
    ...
    public final void blit(class_2960 texture, int x, int y, int u1, int v1, int width, int height, int textureSize, RenderPipeline renderPipeline) {
        this.blit(texture, x, y, u1, v1, width, height, u1 + width, v1 + height, textureSize, renderPipeline);
    }
    ...
    public final void blit(class_2960 texture, int x, int y, int u1, int v1, int width, int height, int u2, int v2, int textureSize, RenderPipeline renderPipeline) {
        ...
        RenderSystem.setShaderTexture((int)0, (GpuTextureView)abstractTexture.method_71659());
        ImmediateRenderUtil.texturedRect(this.pose(), x, y, u1, v1, width, height, u2, v2, textureSize, renderPipeline);
    }
