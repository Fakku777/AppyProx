...
public class DeathpointHandler {
    ...
    public void createDeathpoint(class_1657 player) {
        ...
        if (!potentialAutoContainerPath.equals(usedAutoContainerPath) && (potentialAutoWorldNode = this.session.getWorldStateUpdater().getPotentialWorldNode((class_5321<class_1937>)this.session.getMc().field_1687.method_27983(), worldmap)) != null) {
        ...
        List<String> allPotentialMWIds = this.modMain.getSupportMods().worldmapSupport.getPotentialMultiworldIds((class_5321<class_1937>)player.method_37908().method_27983());
