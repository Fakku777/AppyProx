...
public class WorldMapSession {
    ...
    public void init(class_634 connection, long biomeZoomSeed) throws NoSuchFieldException {
        ...
        TextureUploader textureUploader = new TextureUploader(WorldMap.normalTextureUploadPool, WorldMap.branchUpdatePool, WorldMap.branchUpdateAllocatePool, WorldMap.branchDownloadPool, WorldMap.subsequentNormalTextureUploadPool, WorldMap.textureUploadBenchmark);
        BiomeGetter biomeGetter = new BiomeGetter();
        BrokenBlockTintCache brokenBlockTintCache = new BrokenBlockTintCache(new HashSet<class_2680>(32));
    ...
    public static WorldMapSession getCurrentSession() {
        WorldMapSession session = WorldMapSession.getForPlayer(class_310.method_1551().field_1724);
    ...
    public static WorldMapSession getForPlayer(class_746 player) {
        ...
        return ((IWorldMapClientPlayNetHandler)player.field_3944).getXaero_worldmapSession();
    }
