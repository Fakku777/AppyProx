...
implements IDropDownWidgetCallback {
    ...
    public GuiTransfer(IXaeroMinimap modMain, MinimapSession session, class_437 par1, class_437 escapeScreen) {
        super(modMain, par1, escapeScreen, (class_2561)class_2561.method_43471((String)"gui.xaero_transfer_all"));
    ...
    public void method_25426() {
        super.method_25426();
        this.transferButton = new MySmallButton(5, this.field_22789 / 2 - 155, this.field_22790 / 7 + 120, (class_2561)class_2561.method_43469((String)"gui.xaero_transfer", (Object[])new Object[0]), b -> this.transfer());
        this.method_37063((class_364)this.transferButton);
        this.transferButton.field_22763 = false;
        this.method_37063((class_364)new MySmallButton(6, this.field_22789 / 2 + 5, this.field_22790 / 7 + 120, (class_2561)class_2561.method_43469((String)"gui.xaero_cancel", (Object[])new Object[0]), b -> this.openParent()));
        this.worlds1DD = this.createWorlds1DD();
        this.method_25429(this.worlds1DD);
        this.worlds2DD = this.createWorlds2DD();
        this.method_25429(this.worlds2DD);
        this.containers1DD = this.createContainers1DD();
        this.method_25429(this.containers1DD);
        this.containers2DD = this.createContainers2DD();
        this.method_25429(this.containers2DD);
    }

    private DropDownWidget createWorlds1DD() {
        return DropDownWidget.Builder.begin().setOptions(this.worlds1.options).setX(this.field_22789 / 2 + 2).setY(this.field_22790 / 7 + 20).setW(200).setSelected(this.worlds1.current).setCallback(this).setContainer(this).setNarrationTitle((class_2561)class_2561.method_43471((String)"gui.xaero_dropdown_transfer_worlds1")).build();
    }

    private DropDownWidget createWorlds2DD() {
        return DropDownWidget.Builder.begin().setOptions(this.worlds2.options).setX(this.field_22789 / 2 + 2).setY(this.field_22790 / 7 + 50).setW(200).setSelected(this.worlds2.current).setCallback(this).setContainer(this).setNarrationTitle((class_2561)class_2561.method_43471((String)"gui.xaero_dropdown_transfer_worlds2")).build();
    }

    private DropDownWidget createContainers1DD() {
        return DropDownWidget.Builder.begin().setOptions(this.containers1.options).setX(this.field_22789 / 2 - 202).setY(this.field_22790 / 7 + 20).setW(200).setSelected(this.containers1.current).setCallback(this).setContainer(this).setNarrationTitle((class_2561)class_2561.method_43471((String)"gui.xaero_dropdown_transfer_containers1")).build();
    }

    private DropDownWidget createContainers2DD() {
        return DropDownWidget.Builder.begin().setOptions(this.containers2.options).setX(this.field_22789 / 2 - 202).setY(this.field_22790 / 7 + 50).setW(200).setSelected(this.containers2.current).setCallback(this).setContainer(this).setNarrationTitle((class_2561)class_2561.method_43471((String)"gui.xaero_dropdown_transfer_containers2")).build();
    }
    ...
    protected void renderPreDropdown(class_332 guiGraphics, int mouseX, int mouseY, float partial) {
        ...
        guiGraphics.method_25300(this.field_22793, class_1074.method_4662((String)"gui.xaero_from", (Object[])new Object[0]).replace("\u00a7\u00a7", ":") + ":", this.field_22789 / 2, this.field_22790 / 7 + 10, -1);
        guiGraphics.method_25300(this.field_22793, class_1074.method_4662((String)"gui.xaero_to", (Object[])new Object[0]).replace("\u00a7\u00a7", ":") + ":", this.field_22789 / 2, this.field_22790 / 7 + 40, -1);
    }
