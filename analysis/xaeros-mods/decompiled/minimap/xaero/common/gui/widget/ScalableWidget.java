...
extends Widget {
    ...
    public ScalableWidget(WidgetType type, Class<? extends class_437> location, float horizontalAnchor, float verticalAnchor, ClickAction onClick, HoverAction onHover, int x, int y, int scaledOffsetX, int scaledOffsetY, String url, String tooltip, boolean noGuiScale, double scale) {
