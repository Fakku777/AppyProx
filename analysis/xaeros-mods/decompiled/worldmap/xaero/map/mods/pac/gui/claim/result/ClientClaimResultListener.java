...
implements IClaimsManagerClaimResultListenerAPI {
    public void onClaimResult(AreaClaimResult result) {
        ...
        if (session != null) {
            ...
            resultElement.getFilteredResultTypeIterator().forEachRemaining(type -> mapProcessor.getMessageBox().addMessageWithSource((class_2561)class_2561.method_43470((String)"Claims"), type.message));
        }
    }
}
