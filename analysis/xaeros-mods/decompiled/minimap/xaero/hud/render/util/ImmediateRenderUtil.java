...
public class ImmediateRenderUtil {
    ...
    public static void negativeColorRectangle(class_4587 matrices, float x1, float y1, float x2, float y2) {
        ...
        ImmediateRenderUtil.drawImmediateMeshData(vertexBuffer.method_60794(), CustomRenderTypes.RP_NEGATIVE_COLOR);
    }
    ...
    public static void texturedRect(class_4587 matrixStack, float x, float y, float textureX1, float textureY1, float width, float height, float textureX2, float textureY2, float factor, RenderPipeline renderPipeline) {
        ...
        class_289 tessellator = class_289.method_1348();
        class_287 vertexBuffer = tessellator.method_60827(VertexFormat.class_5596.field_27382, renderPipeline.getVertexFormat());
        vertexBuffer.method_22918(matrix, x + 0.0f, y + height, 0.0f).method_22915(1.0f, 1.0f, 1.0f, 1.0f).method_22913(textureX1 * f, textureY1 * f1);
        vertexBuffer.method_22918(matrix, x + width, y + height, 0.0f).method_22915(1.0f, 1.0f, 1.0f, 1.0f).method_22913(textureX2 * f, textureY1 * f1);
        vertexBuffer.method_22918(matrix, x + width, y + 0.0f, 0.0f).method_22915(1.0f, 1.0f, 1.0f, 1.0f).method_22913(textureX2 * f, textureY2 * f1);
        vertexBuffer.method_22918(matrix, x + 0.0f, y + 0.0f, 0.0f).method_22915(1.0f, 1.0f, 1.0f, 1.0f).method_22913(textureX1 * f, textureY2 * f1);
        ImmediateRenderUtil.drawImmediateMeshData(vertexBuffer.method_60794(), renderPipeline);
    }
