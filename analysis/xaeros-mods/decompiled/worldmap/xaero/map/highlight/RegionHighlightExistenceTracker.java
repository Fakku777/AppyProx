...
public class RegionHighlightExistenceTracker {
    ...
    private void requestBranchUpdates(int regionX, int regionZ) {
        for (int i = 1; i <= 3; ++i) {
            ...
            if (leveledParent == null) continue;
    ...
    public void onClearCachedHashes() {
        this.regionsToTrackExistenceOf.forEach(key -> this.requestBranchUpdates(DimensionHighlighterHandler.getXFromKey(key), DimensionHighlighterHandler.getZFromKey(key)));
